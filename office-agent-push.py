...
# === 你需要填入的信息 ===
JOIN_KEY = "ocj_starteam_astra"   # 必填：你的一次性 join key
AGENT_NAME = "Astra" # 必填：你在办公室里的名字
OFFICE_URL = "http://127.0.0.1:19000"  # 海辛办公室地址
...
LOCAL_STATE_FILE = os.environ.get("OFFICE_LOCAL_STATE_FILE", os.path.join(os.path.dirname(os.path.abspath(__file__)), "state.json"))
